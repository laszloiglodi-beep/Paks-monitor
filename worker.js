export default {
  async fetch(request) {
    ...
    // =====================================================
    // FACEBOOK KÉP KISZOLGÁLÁSA SAJÁT WORKER CÍMRŐL
    // =====================================================

    if (reqUrl.pathname === "/facebook-image") {
...
<meta
  ...
  content="Élő adatok a Paksi Atomerőműről és a Duna paksi vízállásáról."
>
...
function drawChart(
  ...
  if(
    ...
    ctx.fillText(
      "A grafikon adatgyűjtése elindult…",
      pad.left + 8,
      H / 2
    );
