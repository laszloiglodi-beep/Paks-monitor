...
const VERSION = "PAKS MONITOR V10";
...
async function getCurrentData() {
  ...
  const validBlocks = blocks.every(
    value =>
      /^\d+$/.test(String(value))
  );
...
<div class="source">
  VÍZHŐMÉRSÉKLET • FRISS ADAT HIÁNYZIK
</div>
...
<div class="sceneNote">
  SEMATIKUS ÁBRA • NEM SZINTEZETT HOSSZ-SZELVÉNY
</div>
